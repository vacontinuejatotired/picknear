...
| 文档 | 说明 |
|------|------|
| [后端架构](arch/README.md) | 后端架构模块入口 |
| [系统架构设计](arch/系统架构设计.md) | 当前域划分、请求链和基础设施 |
...
| [后端架构拆分记录](report/后端架构拆分记录.md) | 历史拆分方案与落地记录 |
| [后端架构审查报告](report/后端架构审查报告.md) | 全后端架构审查记录 |
| [架构毁灭者审查报告](report/架构毁灭者-代码挑刺专家.md) | 第三方架构挑刺记录 |
| [其他模块审查](report/其他模块审查-blog-follow.md) | Blog/Follow 审查记录 |
| [商店查询接口设计记录](report/商店通用查询接口设计记录.md) | 商铺通用查询设计记录 |
| [非认证模块优化方案](report/非认证模块优化方案.md) | 秒杀、商铺、Upload 和 MQ 优化记录 |
